...
let usingStyles = makeStyles((theme) => ({
  root: {
    minWidth: 0,
    marginTop: "10px",
    marginBottom: "10px",
  ...
  dot: {
    ...
    let GithubPane = ({repo, language}) => {

    let classes = usingStyles();
    let repo_color = (repo_lang) => language[repo_lang]["color"] == null ? "#FF0000" : language[repo_lang]["color"];
          ...
          {repo.language ? (
            <React.Fragment>
              <span
                ...
                style={{ backgroundColor: repo_color(repo.language) }}
              ></span>
